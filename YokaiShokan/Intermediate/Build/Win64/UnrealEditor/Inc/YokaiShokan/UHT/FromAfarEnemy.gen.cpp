...
struct Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_YokaiShokan_YokaiShokan_Source_YokaiShokan_FromAfarEnemy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFromAfarEnemy, AFromAfarEnemy::StaticClass, TEXT("AFromAfarEnemy"), &Z_Registration_Info_UClass_AFromAfarEnemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFromAfarEnemy), 3902032045U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_YokaiShokan_YokaiShokan_Source_YokaiShokan_FromAfarEnemy_h_624627925(TEXT("/Script/YokaiShokan"),
