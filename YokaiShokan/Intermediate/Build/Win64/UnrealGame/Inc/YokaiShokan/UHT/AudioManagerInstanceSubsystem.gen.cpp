...
struct Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_YokaiShokan_YokaiShokan_Source_YokaiShokan_AudioManagerInstanceSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAudioManagerInstanceSubsystem, UAudioManagerInstanceSubsystem::StaticClass, TEXT("UAudioManagerInstanceSubsystem"), &Z_Registration_Info_UClass_UAudioManagerInstanceSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioManagerInstanceSubsystem), 1398629755U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_YokaiShokan_YokaiShokan_Source_YokaiShokan_AudioManagerInstanceSubsystem_h_4037051363(TEXT("/Script/YokaiShokan"),
